...
namespace EFRepository
{
    public class Repository : IRepository, IDisposable
    {
        ...
        public Repository(DbContext context, bool autoDetectChangesEnabled = false, bool proxCreationEnabled = false)
        {
            this.Context = context;
            this.Context.Configuration.AutoDetectChangesEnabled = autoDetectChangesEnabled;
            this.Context.Configuration.ProxyCreationEnabled = proxCreationEnabled;
        }
        ...
        public IPagedList<TEntity> FindEntitySePaget<TEntity>(Expression<Func<TEntity, bool>> criteria,
            Expression<Func<TEntity, string>> order, int page, int pageSize) where TEntity : class
        {
            ...
            try
            {
                var registrosActuales = Context.Set<TEntity>().Where(criteria).OrderBy(order).Select(p => p).ToPagedList(page, page);
